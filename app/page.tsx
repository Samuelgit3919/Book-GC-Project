...
export default function Home() {
  return (
    <section className='bg-purple-50 py-12'>
      <div className="container mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:space-x-8 space-y-12 lg:space-y-0">
  {/* Text Section */}
  <div className="w-full lg:w-2/5 text-center lg:text-left">
    <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl text-purple-800 mb-6 leading-tight">
      Welcome to BookCompass <br /> Online Book Navigator
    </h1>
    <p className="text-gray-700 mb-8 text-sm md:text-base">
      Discover a world of books with ease. BookCompass provides an intuitive way
      to explore, compare, and purchase books online. Join a thriving community
      of readers!
    </p>
    ...
    <div className="flex flex-wrap justify-center lg:justify-start items-center gap-8 mb-8">
      <div className="text-center flex flex-col items-center">
        ...
        <p className="text-gray-600 text-sm md:text-base">Book Collections</p>
      </div>
    ...
    <div className="flex justify-center lg:justify-start">
      <a
        href="#"
        className="inline-flex items-center gap-3 px-6 py-3 text-white font-semibold bg-purple-700 hover:bg-purple-800 transition rounded-md shadow-md hover:shadow-lg"

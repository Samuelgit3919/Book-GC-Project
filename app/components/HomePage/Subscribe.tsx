...
const Subscribe = () => {
    return (
        <div>
            <div className='md:flex md:flex-row flex flex-col bg-purple-950 text-white p-8 justify-center gap-24'>
            ...
            <div className="bg-purple-500  py-12 px-4 sm:px-6 lg:px-8">
